...
FUNCAPI void APIENTRY auxExposeFunc(AUXEXPOSEPROC Func)
{
/*      Change by Thierry DECHAIZE :   replace ((void*)Func) by ((void (*)(int, int))Func) */
    tkExposeFunc((void (*)(int, int))Func);
}

FUNCAPI void APIENTRY auxReshapeFunc(AUXRESHAPEPROC Func)
{
/*      Change by Thierry DECHAIZE :   replace ((void*)Func) by ((void (*)(int, int))Func) */
...
FUNCAPI void APIENTRY auxIdleFunc(AUXIDLEPROC Func)
{
/*      Change by Thierry DECHAIZE :   replace ((void*)Func) by ((void (*)(void))Func) */
    tkIdleFunc((void (*)(void))Func);
}

FUNCAPI void APIENTRY auxKeyFunc(int key, AUXKEYPROC Func)
{
...
FUNCAPI void APIENTRY auxMouseFunc(int mouse, int mode, AUXMOUSEPROC Func)
{
    if (mode == AUX_MOUSEDOWN) {
	mouseDownTable[mouseDownTableCount].mouseField = mouse;
/*      Change by Thierry DECHAIZE :   replace = (void*)Func;    by      = (void (*)(AUX_EVENTREC *))Func; */
...
FUNCAPI void APIENTRY auxMainLoop(AUXMAINPROC Func)
{
/*      Change by Thierry DECHAIZE :   replace ((void*)Func) by ((void (*)(void))Func) */
...
FUNCAPI void APIENTRY auxInitPosition(int x, int y, int width, int height)
{
    tkInitPosition(x, y, width, height);
}

FUNCAPI void APIENTRY auxInitDisplayMode(GLenum type)
{
    displayModeType = type;
    tkInitDisplayMode(type);
}

FUNCAPI void APIENTRY auxInitDisplayModePolicy(GLenum type)
{
    tkInitDisplayModePolicy(type);
}

FUNCAPI GLenum APIENTRY auxInitDisplayModeID(GLint id)
{
...
FUNCAPI void APIENTRY auxSetOneColor(int index, float r, float g, float b)
{
    tkSetOneColor(index, r, g, b);
}

FUNCAPI void APIENTRY auxSetFogRamp(int density, int startIndex)
{
...
FUNCAPI void APIENTRY auxSetRGBMap(int size, float *rgb)
{
...
FUNCAPI void APIENTRY auxGetMouseLoc(int *x, int *y)
{
    tkGetMouseLoc(x, y);
}
