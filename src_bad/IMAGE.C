...
__declspec(dllexport) AUX_RGBImageRec APIENTRY *auxDIBImageLoadA(LPCSTR filename)
{
    return (AUX_RGBImageRec *)tkDIBImageLoadAW((char *)filename, FALSE);
}

__declspec(dllexport) AUX_RGBImageRec APIENTRY *auxDIBImageLoadW(LPCWSTR filename)
{
