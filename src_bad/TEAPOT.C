...
static void APIENTRY solidTeapot(long grid, GLdouble scale)
{
...
static void APIENTRY wireTeapot(long grid, GLdouble scale)
{
    float p[4][4][3], q[4][4][3], r[4][4][3], s[4][4][3];
    long i, j, k, l;
...
__declspec(dllexport) void APIENTRY auxSolidTeapot(GLdouble scale)
{
...
__declspec(dllexport) void APIENTRY auxWireTeapot(GLdouble scale)
{
